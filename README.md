...
| **`CoupledDynamics.m`** | Defines the full coupled network dynamics ($\dot{X}$) required by `ode45`. Implements the diffusive coupling. | Applies coupling through Projection Matrix **$P$** and Laplacian **$L$** |
